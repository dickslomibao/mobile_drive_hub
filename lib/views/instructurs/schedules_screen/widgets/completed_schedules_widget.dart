...
class CompletedSchedulesWidget extends StatefulWidget {
  const CompletedSchedulesWidget({super.key, required this.schedules});
  final List<dynamic> schedules;
  @override
  State<CompletedSchedulesWidget> createState() =>
      _CompletedSchedulesWidgetState();
}

class _CompletedSchedulesWidgetState extends State<CompletedSchedulesWidget> {
  @override
