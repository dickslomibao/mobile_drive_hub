...
class AllScheduleWidget extends StatefulWidget {
  const AllScheduleWidget({super.key, required this.schedules});
  final List<dynamic> schedules;
  @override
  State<AllScheduleWidget> createState() => _AllScheduleWidgetState();
}

class _AllScheduleWidgetState extends State<AllScheduleWidget> {
  @override
  Widget build(BuildContext context) {
    final watch = context.watch<InstructorScheduleController>();
    final schedules = watch.schedules.reversed.toList();
    print(schedules);
